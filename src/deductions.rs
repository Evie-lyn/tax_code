...
pub fn ak_standard_deduction(_filing_status: &crate::FilingStatus) -> Deduction {
    Deduction { standard_deduction: 0.0 }
}

//Arizona 2024
pub fn az_standard_deduction_2024 (filing_status: &crate::FilingStatus) -> Deduction{
    match filing_status {
...
//Arkansas 2024
pub fn ar_standard_deduction_2024 (filing_status: &crate::FilingStatus) -> Deduction{
    match filing_status {
...
//California
pub fn ca_standard_deduction_2024 (filing_status: &crate::FilingStatus) -> Deduction{
    match filing_status {
...
pub fn co_standard_deduction(_filing_status: &crate::FilingStatus) -> Deduction {
    Deduction { standard_deduction: 0.0 }
}

//Connecticut (No Standard deduction)
pub fn ct_standard_deduction(_filing_status: &crate::FilingStatus) -> Deduction {
    Deduction { standard_deduction: 0.0 }
}

//Delaware
pub fn de_standard_deduction_2024 (filing_status: &crate::FilingStatus) -> Deduction{
    match filing_status {
...
pub fn fl_standard_deduction(_filing_status: &crate::FilingStatus) -> Deduction {
    Deduction { standard_deduction: 0.0 }
}

//Georgia
pub fn ga_standard_deduction_2024 (filing_status: &crate::FilingStatus) -> Deduction{
    match filing_status {
...
//Hawaii
pub fn hi_standard_deduction_2024 (filing_status: &crate::FilingStatus) -> Deduction{
    match filing_status {
...
pub fn hi_standard_deduction_2025 (filing_status: &crate::FilingStatus) -> Deduction{
    match filing_status {
        crate::FilingStatus::Single => Deduction { standard_deduction: 4400.0 }, 
        crate::FilingStatus::MarriedFilingSeparately => Deduction { standard_deduction: 4400.0 }, 
        crate::FilingStatus::MarriedFilingJointly => Deduction { standard_deduction: 8800.0 },
...
//Idaho
pub fn id_standard_deduction_2024 (filing_status: &crate::FilingStatus) -> Deduction{
    match filing_status {
        crate::FilingStatus::Single => Deduction { standard_deduction: 14600.0 }, 
        crate::FilingStatus::MarriedFilingSeparately => Deduction { standard_deduction: 14600.0 }, 
        crate::FilingStatus::MarriedFilingJointly => Deduction { standard_deduction: 29200.0 },
...
pub fn id_standard_deduction_2025 (filing_status: &crate::FilingStatus) -> Deduction{
    match filing_status {
...
pub fn il_standard_deduction(_filing_status: &crate::FilingStatus) -> Deduction {
    Deduction { standard_deduction: 0.0 }
}

//Indiana (No Standard deduction)
pub fn in_standard_deduction(_filing_status: &crate::FilingStatus) -> Deduction {
    Deduction { standard_deduction: 0.0 }
}

//Iowa
pub fn ia_standard_deduction_2024 (filing_status: &crate::FilingStatus) -> Deduction{
    match filing_status {
        crate::FilingStatus::Single => Deduction { standard_deduction: 14600.0 }, 
        crate::FilingStatus::MarriedFilingSeparately => Deduction { standard_deduction: 14600.0 }, 
        crate::FilingStatus::MarriedFilingJointly => Deduction { standard_deduction: 29200.0 },
...
pub fn ia_standard_deduction_2025 (filing_status: &crate::FilingStatus) -> Deduction{
    match filing_status {
        crate::FilingStatus::Single => Deduction { standard_deduction: 15000.0 }, 
        crate::FilingStatus::MarriedFilingSeparately => Deduction { standard_deduction: 15000.0 }, 
        crate::FilingStatus::MarriedFilingJointly => Deduction { standard_deduction: 30000.0 },
...
//Kansas
pub fn ks_standard_deduction_2024 (filing_status: &crate::FilingStatus) -> Deduction{
    match filing_status {
...
//Kentucky
pub fn ky_standard_deduction_2024 (filing_status: &crate::FilingStatus) -> Deduction{
    match filing_status {
...
pub fn ky_standard_deduction_2025 (filing_status: &crate::FilingStatus) -> Deduction{
    match filing_status {
