...
pub fn nc_head_of_household_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nc_married_filing_jointly_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nc_married_filing_separately_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nc_qualifying_surviving_spouse_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nc_single_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nc_head_of_household_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nc_married_filing_jointly_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nc_married_filing_separately_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nc_qualifying_surviving_spouse_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nc_single_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nd_head_of_household_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(63175.0, 0.0),
        Bracket(264100.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nd_married_filing_jointly_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(78775.0, 0.0),
        Bracket(289975.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nd_married_filing_separately_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(39375.0, 0.0),
        Bracket(144975.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nd_qualifying_surviving_spouse_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(78775.0, 0.0),
        Bracket(289975.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
...
pub fn nd_single_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(47150.0, 0.0),
        Bracket(238200.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nd_head_of_household_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(64950.0, 0.0),
        Bracket(271450.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nd_married_filing_jointly_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(80975.0, 0.0),
        Bracket(298075.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nd_married_filing_separately_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(40475.0, 0.0),
        Bracket(149025.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn nd_qualifying_surviving_spouse_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(80975.0, 0.0),
        Bracket(298075.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
...
pub fn nd_single_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(48475.0, 0.0),
...
pub fn nm_head_of_household_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(8000.0, 0.0),
        Bracket(16000.0, 0.0),
        Bracket(24000.0, 0.0),
        Bracket(315000.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
    ]
}

pub fn nm_married_filing_jointly_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(8000.0, 0.0),
        Bracket(16000.0, 0.0),
        Bracket(24000.0, 0.0),
...
pub fn nm_married_filing_separately_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(4000.0, 0.0),
        Bracket(8000.0, 0.0),
        Bracket(12000.0, 0.0),
        Bracket(157500.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
    ]
}

pub fn nm_qualifying_surviving_spouse_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(8000.0, 0.0),
        Bracket(16000.0, 0.0),
        Bracket(24000.0, 0.0),
...
pub fn nm_single_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(5500.0, 0.0),
        Bracket(11000.0, 0.0),
        Bracket(16000.0, 0.0),
...
pub fn ny_head_of_household_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(12800.0, 0.0),
        Bracket(17650.0, 0.0),
        Bracket(20900.0, 0.1),
        Bracket(107650.0, 0.1),
        Bracket(269300.0, 0.1),
        Bracket(1616450.0, 0.1),
...
pub fn ny_married_filing_jointly_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(17150.0, 0.0),
        Bracket(23600.0, 0.0),
        Bracket(27900.0, 0.1),
        Bracket(161550.0, 0.1),
        Bracket(323200.0, 0.1),
        Bracket(2155350.0, 0.1),
        Bracket(5000000.0, 0.1),
        Bracket(25000000.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
    ]
...
pub fn ny_married_filing_separately_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(8500.0, 0.0),
        Bracket(11700.0, 0.0),
        Bracket(13900.0, 0.1),
...
pub fn ny_qualifying_surviving_spouse_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(17150.0, 0.0),
        Bracket(23600.0, 0.0),
        Bracket(27900.0, 0.1),
...
pub fn ny_single_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(8500.0, 0.0),
        Bracket(11700.0, 0.0),
        Bracket(13900.0, 0.1),
...
pub fn oh_head_of_household_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(26050.0, 0.0),
        Bracket(100000.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
...
pub fn oh_married_filing_jointly_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(26050.0, 0.0),
        Bracket(100000.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
...
pub fn oh_married_filing_separately_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(26050.0, 0.0),
        Bracket(100000.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
...
pub fn oh_qualifying_surviving_spouse_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(26050.0, 0.0),
        Bracket(100000.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
...
pub fn oh_single_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(26050.0, 0.0),
        Bracket(100000.0, 0.0),
        Bracket(f64::INFINITY, 0.0),
...
pub fn ok_head_of_household_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(2000.0, 0.0),
        Bracket(5000.0, 0.0),
        Bracket(7500.0, 0.0),
...
pub fn ok_married_filing_jointly_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(2000.0, 0.0),
        Bracket(5000.0, 0.0),
        Bracket(7500.0, 0.0),
...
pub fn ok_married_filing_separately_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(1000.0, 0.0),
        Bracket(2500.0, 0.0),
        Bracket(3750.0, 0.0),
...
pub fn ok_qualifying_surviving_spouse_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(2000.0, 0.0),
        Bracket(5000.0, 0.0),
        Bracket(7500.0, 0.0),
...
pub fn ok_single_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(1000.0, 0.0),
        Bracket(2500.0, 0.0),
        Bracket(3750.0, 0.0),
...
pub fn or_head_of_household_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(8600.0, 0.0),
        Bracket(21500.0, 0.1),
        Bracket(250000.0, 0.1),
...
pub fn or_married_filing_jointly_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(8600.0, 0.0),
        Bracket(21500.0, 0.1),
        Bracket(250000.0, 0.1),
...
pub fn or_married_filing_separately_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(4300.0, 0.0),
        Bracket(10750.0, 0.1),
        Bracket(125000.0, 0.1),
...
pub fn or_qualifying_surviving_spouse_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(8600.0, 0.0),
        Bracket(21500.0, 0.1),
        Bracket(250000.0, 0.1),
...
pub fn or_single_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(4300.0, 0.0),
        Bracket(10750.0, 0.1),
        Bracket(125000.0, 0.1),
...
pub fn pa_head_of_household_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn pa_married_filing_jointly_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn pa_married_filing_separately_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn pa_qualifying_surviving_spouse_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn pa_single_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn pa_head_of_household_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn pa_married_filing_jointly_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn pa_married_filing_separately_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn pa_qualifying_surviving_spouse_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn pa_single_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn ri_head_of_household_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(77450.0, 0.0),
        Bracket(176050.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
    ]
}

pub fn ri_married_filing_jointly_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(77450.0, 0.0),
        Bracket(176050.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
...
pub fn ri_married_filing_separately_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(77450.0, 0.0),
        Bracket(176050.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
...
pub fn ri_qualifying_surviving_spouse_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(77450.0, 0.0),
        Bracket(176050.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
...
pub fn ri_single_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(77450.0, 0.0),
        Bracket(176050.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
...
pub fn ri_head_of_household_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(79900.0, 0.0),
...
pub fn ri_married_filing_jointly_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(79900.0, 0.0),
        Bracket(181650.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
...
pub fn ri_married_filing_separately_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(79900.0, 0.0),
        Bracket(181650.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
...
pub fn ri_qualifying_surviving_spouse_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(79900.0, 0.0),
        Bracket(181650.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
...
pub fn ri_single_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(79900.0, 0.0),
        Bracket(181650.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
...
pub fn sc_head_of_household_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(3460.0, 0.0),
        Bracket(17330.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
...
pub fn sc_married_filing_jointly_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(3460.0, 0.0),
        Bracket(17330.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
...
pub fn sc_married_filing_separately_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(3460.0, 0.0),
        Bracket(17330.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
...
pub fn sc_qualifying_surviving_spouse_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(3460.0, 0.0),
        Bracket(17330.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
...
pub fn sc_single_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(3460.0, 0.0),
        Bracket(17330.0, 0.0),
        Bracket(f64::INFINITY, 0.1),
...
pub fn sd_head_of_household_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn sd_married_filing_jointly_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn sd_married_filing_separately_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn sd_qualifying_surviving_spouse_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn sd_single_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn sd_head_of_household_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn sd_married_filing_jointly_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn sd_married_filing_separately_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn sd_qualifying_surviving_spouse_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn sd_single_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}
...
pub fn ut_head_of_household_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn ut_married_filing_jointly_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn ut_married_filing_separately_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn ut_qualifying_surviving_spouse_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn ut_single_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn ut_head_of_household_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn ut_married_filing_jointly_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn ut_married_filing_separately_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn ut_qualifying_surviving_spouse_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}

pub fn ut_single_tax_2025() -> Vec<Bracket> {
    vec![
        Bracket(f64::INFINITY, 0.0),
    ]
}
...
pub fn vt_head_of_household_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(75000.0, 0.0),
        Bracket(165700.0, 0.1),
        Bracket(268300.0, 0.1),
        Bracket(f64::INFINITY, 0.1),
    ]
}

pub fn vt_married_filing_jointly_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(79950.0, 0.0),
        Bracket(193300.0, 0.1),
        Bracket(294600.0, 0.1),
        Bracket(f64::INFINITY, 0.1),
    ]
}

pub fn vt_married_filing_separately_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(75000.0, 0.0),
        Bracket(96650.0, 0.1),
        Bracket(147300.0, 0.1),
        Bracket(f64::INFINITY, 0.1),
    ]
}

pub fn vt_qualifying_surviving_spouse_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(79950.0, 0.0),
        Bracket(193300.0, 0.1),
        Bracket(294600.0, 0.1),
...
pub fn vt_single_tax_2024() -> Vec<Bracket> {
    vec![
        Bracket(75000.0, 0.0),
